...
internal val journalTextsEn = JournalTexts(
    returns = ReturnJournalTexts(
        ...
        noBasisHint = "Turn to another day or type the number of the receipt the customer brought.",
        ...
        noSaleBasis = "That day has no sales that can be refunded.",
        noBuyBasis = "That day has no purchases that can be refunded.",
