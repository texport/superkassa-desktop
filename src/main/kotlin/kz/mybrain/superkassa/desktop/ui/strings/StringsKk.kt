...
internal val KazakhStrings = AppStrings(
    common = CommonStrings(
        ...
        nodeUnexplained = "Түйін бас тартты, себебін айтпады. Қайталаңыз; бас тарту қайталанса — қызмет көрсетуді шақырыңыз.",
    ...
    login = LoginStrings(
        ...
        kkmsUnread = "Түйін кассалар тізімін бермеді, бұл түйінде қанша касса бары белгісіз. " +
            "Баптаулардағы түйін мекенжайын тексеріп, қайталаңыз.",
