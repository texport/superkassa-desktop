...
data class CommonStrings(
    ...
    /**
     * Что делать, когда прочитать не удалось.
     *
     * Совет один на все чтения: журнал, смены и чеки дня отказывают
     * по одной и той же причине — узел молчит или отвечает отказом, —
     * и три своих объяснения разошлись бы на первой же правке.
     */
