...
internal val RussianStrings = AppStrings(
    common = CommonStrings(
        ...
        nodeUnexplained = "Узел отказал и причины не назвал. Повторите; если отказ повторится — позовите обслуживание.",
    ...
    login = LoginStrings(
        ...
        kkmsUnread = "Узел не отдал список касс, и сколько их на этом узле — неизвестно. " +
