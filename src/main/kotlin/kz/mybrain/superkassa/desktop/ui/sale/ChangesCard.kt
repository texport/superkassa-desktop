        ...
        Column(
            ...
            CollapsibleSection(title = extra.receiptChanges, expanded = expanded, onToggle = onToggle) {
                ...
                AdjustmentField(
                    ...
                    supportingText = sameOtherwise(form.discount, basket.total, extra.changeAsPercent),
                ...
                AdjustmentField(
                    ...
                    supportingText = sameOtherwise(form.markup, basket.total, extra.changeAsPercent),
