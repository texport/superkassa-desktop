...
/**
 * Слагаемое итога: подпись слева, сумма справа моноширинным столбцом.
 *
 * Приглушено намеренно — эти строки объясняют итог, а не заменяют его.
 */

/**
 * Главное число блока: подпись строкой выше, сумма под ней во всю ширину.
 *
 * Подпись и сумма не делят строку пополам намеренно: крупная сумма
 * в узкой колонке иначе упирается в подпись и обрезается.
 */
