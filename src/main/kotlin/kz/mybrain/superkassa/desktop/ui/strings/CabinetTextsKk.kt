...
internal val cabinetTextsKk = CabinetTexts(
    ...
    registersEmptyHint = "Алдымен кассаны құрыңыз, содан соң ИСНА-ға есепке қою өтінішін беріңіз",
    ...
    okedNotFound = "Бұл сұрау бойынша жіктеуіштен ештеңе табылмады",
    ...
    applicationInFlight = "Өтініш берілген — жаңасын ИСНА жауабынан кейін беруге болады",
