...
internal val moneyTextsRu = MoneyTexts(
    ...
    cashiers = CashierTexts(
        ...
        deleteBlocked = "Единственного администратора удалять нельзя: некому будет заводить кассиров и менять настройки. Заведите второго администратора, потом удаляйте.",
        changePinFor = "Новый пин для %s",
        onlyInRole = "Единственный администратор",
