...
private val setupTextsRu = SetupTexts(
    ...
    stepApplicationHint = "Заявление подписывается ЭЦП и уходит в ИСНА; ответ приходит не сразу",
    submit = "Подать заявление",
    awaitingIsna = "Заявление отправлено, ждём ответа ИСНА",
...
private val setupTextsKk = SetupTexts(
    ...
    stepApplicationHint = "Өтініш ЭЦҚ-мен қол қойылып ИСНА-ға жіберіледі; жауап бірден келмейді",
    submit = "Өтініш беру",
    awaitingIsna = "Өтініш жіберілді, ИСНА жауабын күтудеміз",
...
private val setupTextsEn = SetupTexts(
    ...
    stepApplicationHint = "The application is signed and sent to ISNA; the answer does not come at once",
    submit = "Submit the application",
    awaitingIsna = "Application sent, waiting for ISNA",
