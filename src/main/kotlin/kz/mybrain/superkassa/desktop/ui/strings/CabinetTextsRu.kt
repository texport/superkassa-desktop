...
internal val cabinetTextsRu = CabinetTexts(
    ...
    registersEmptyHint = "Заведите кассу, а затем подайте заявление в ИСНА на постановку на учёт",
