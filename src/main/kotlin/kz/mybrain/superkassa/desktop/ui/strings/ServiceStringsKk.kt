...
internal val kazakhSettings = SettingStrings(
    ...
    dictionariesMissing = "Түйін анықтамалықтары оқылмаған",
    dictionariesMissingHint = "Салық режимдері мен ҚҚС мөлшерлемелері түйіннен келеді. Жұмыс орны оларды сұрағанда түйін жауап бермеді — қайталап көріңіз.",
    ...
    nodeStorage = "Қоймасы",
    nodeRenderer = "Құжат бейнелері",
    nodeRendererMissing = "браузер жоқ — қарау мен басып шығару істемейді: Chrome, Chromium немесе Edge орнатыңыз",
    nodeHealth = "Күйі",
...
internal val kazakhPreview = PreviewStrings(
    ...
    noDrawer = "Құжат кабинеттен келді, ал ол бойынша басып шығару пішінін осы машинадағы " +
        "касса салады. Түйін бірде-бір касса бермеді — салатын ештеңе жоқ."
)
