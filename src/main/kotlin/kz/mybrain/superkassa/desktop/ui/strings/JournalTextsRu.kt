...
internal val journalTextsRu = JournalTexts(
    returns = ReturnJournalTexts(
        ...
        noBasisHint = "Перелистните день или наберите номер чека, который принёс покупатель.",
        ...
        noSaleBasis = "За этот день нет продаж, по которым можно оформить возврат.",
        noBuyBasis = "За этот день нет покупок, по которым можно оформить возврат.",
