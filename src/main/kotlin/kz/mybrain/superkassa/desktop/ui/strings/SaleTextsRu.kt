...
internal val saleTextsRu = SaleTexts(
    ...
    domainHint = "Реквизиты отрасли обязательны: без них БФД чек отвергнет",
    accountNumber = "Лицевой счёт",
    cardNumber = "Номер карты",
    carNumber = "Номер машины",
    fee = "Тариф",
    byOrder = "По заказу",
    parkingFrom = "Время въезда",
    parkingTo = "Время выезда",
    fillIn = "Заполните",
    numberField = "%s — это число",
    timeField = "%s — это часы и минуты, например 9:30",
